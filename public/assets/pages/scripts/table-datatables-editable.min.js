    ...
    var e = function () {
        ...
        function t(e, t) {
            ...
            a[0].innerHTML = '' +
                ...
                'value="' + n[0] + '">',
                a[1].innerHTML = '<input type="text" class="form-control input-small" ' +
                    'value="' + n[1] + '">',
                a[2].innerHTML = '<input type="text" class="form-control input-small" ' +
                    'value="' + n[2] + '">',
                a[3].innerHTML = '<input type="text" class="form-control input-small" ' +
                    'value="' + n[3] + '">',
                a[4].innerHTML = '<button type="submit" class="edit" href="">Save</button>',
